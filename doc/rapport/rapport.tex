...
\begin{document}
	...
	\section{Technologies}
		...
		\subsection{État de l'art}
			\todo{\url{https://en.wikipedia.org/wiki/Comparison_of_parser_generators}}
	...
	\section{Planification des tâches}
		...
		\begin{enumerate}
			...
			\subitem + Intégration dans le CLI
		...
		La tâche \textit{Intégration dans le CLI} se fait en parallèle des étapes. Toutes ces fonctionnalités allant dans le CLI pour être mise en commun, et fournir une interface utilisateur simple. Il paraît donc évident que le CLI doit être développé en même temps.
		...
		\subsection{Définition de l'AST pour la grammaire choisie}
			...
			\begin{figure}[H]
				...
				\begin{tabular}{ll}
					...
					\texttt{PP.Grammar} & Module pour le parsing d'une grammaire\\
					\texttt{PP.Grammars} & Import général pour les grammaires pré-définies\\
					\texttt{PP.Grammars.EBNF} & AST pour la grammaire EBNF\\
				\end{tabular}
				\caption{Modules pour ce qui touche la grammaire}
			\end{figure}
	...
	\label{sec:creation-d-un-parser-pour-la-grammaire}
		...
		\subsection{Intégration dans le CLI}
			\todo{}
