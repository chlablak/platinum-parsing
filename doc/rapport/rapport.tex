...
\begin{document}
	...
	\section{Technologies}
		...
		\subsection{Choix du langage}
			...
			Haskell possède également d'autres avantages et il est utilisé par de nombreuses entreprises pour certains projets, notamment il est populaire pour le lexing/parsing. Voici quelques liens de départ pour en savoir plus:
			\begin{itemize}
		...
		\label{subsec:criteres-testes-pour-le-choix-du-langage}
			...
			\subsubsection{Langage Haskell}
				...
				\begin{listing}[H]
					...
					\end{minted}
					\caption{Utilisation de Parsec avec Haskell}
				\end{listing}
			...
			\subsubsection{Langage C\#}
				...
				\begin{listing}[H]
					...
					\end{minted}
					\caption{Utilisation de Irony avec C\#}
				\end{listing}
			...
			\subsubsection{Langage F\#}
				...
				\begin{listing}[H]
					...
					\end{minted}
					\caption{Utilisation de FParsec avec F\#}
				\end{listing}
