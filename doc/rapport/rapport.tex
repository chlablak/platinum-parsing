...
\begin{document}
	...
	\section{Technologies}
		...
		\subsection{Choix du langage}
			...
			Pour choisir entre ces différentes options, nous allons nous baser sur plusieurs critères pour lesquels chaque langage sera mis en compétition. Les différents critères seront séparés en deux groupes: un groupe de critères essentiels pour le projet, et un groupe de critères moins important mais permettant de comparer les langages tout de même. Les critères essentiels sont éliminatifs, c'est-à-dire qu'un langage qui ne répondrait pas à l'un de ces critères est d'emblée supprimé: 
			\begin{figure}[H]
				\centering
				\begin{tabular}{|c|l|c|c|c|}
					...
					\hline
					1.1 & Le langage a une communauté active et des ressources sur internet & - & - & -\\
					1.2 & Le langage possède une ou des bibliothèques dans le domaine du \textit{parsing} & - & - & -\\
					1.3 & L'implémentation d'un parser de test simple ne demande pas trop de travail & - & - & -\\
					\hline
					\multicolumn{5}{|c|}{\textit{Critères de comparaison}}\\
					\hline
					2.1 & Vitesse d'exécution du parser de test & - & - & -\\
					2.2 & Quantité et qualité du code nécessaire pour le parser de test & - & - & -\\
					\hline\hline
	...
	\section{Annexes}
		...
		\label{subsec:criteres-testes-pour-le-choix-du-langage}
			...
			\subsubsection{1.1 - Le langage a une communauté active et des ressources sur internet}
			
			\subsubsection{1.2 - Le langage possède une ou des bibliothèques dans le domaine du \textit{parsing}}
			
			\subsubsection{1.3 - L'implémentation d'un parser de test simple ne demande pas trop de travail}
				\todo{ebnf simple}
			
			\subsubsection{2.1 - Vitesse d'exécution du parser de test}
			
			\subsubsection{2.2 - Quantité et qualité du code nécessaire pour le parser de test}
