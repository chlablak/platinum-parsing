...
\begin{document}
	...
	\section{Études des cas d'utilisation}
		...
		\begin{itemize}
			\item le \textbf{concepteur} de langage veut pouvoir définir sa grammaire EBNF \cite{ebnf}, ainsi que la vérifier (erreur de syntaxe, ambiguïté, etc.)
		...
		\subsection{Références}
			\begingroup
				...
				\begin{thebibliography}{9}
					...
					\bibitem{ebnf} EBNF, Extended Backus-Naur form,\\ 
