...
\begin{document}
	...
	\section{Intégration de l'analyse lexicale}
		...
		\subsection{Génération des automates pour l'analyse lexicale}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.5\textwidth]{../diagrams/misc/dfa-exemple}
		...
		\subsection{Implémentation du \textit{lexer} complet}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.5\textwidth]{../diagrams/misc/lexer-dfa}
	...
	\section{Intégration à un éditeur de texte}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.7\textwidth]{../diagrams/atom/create-menu}
			\includegraphics[width=0.8\textwidth]{../diagrams/atom/create-dialog}
			\includegraphics[width=0.7\textwidth]{../diagrams/atom/create-folder}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.7\textwidth]{../diagrams/atom/created-project}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{../diagrams/atom/simple-project}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.7\textwidth]{../diagrams/atom/build-menu}
			\includegraphics[width=0.8\textwidth]{../diagrams/atom/build-results}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.7\textwidth]{../diagrams/atom/test-menu}
			\includegraphics[width=0.8\textwidth]{../diagrams/atom/test-dialog}
			\includegraphics[width=0.5\textwidth]{../diagrams/atom/ast-viewer}
