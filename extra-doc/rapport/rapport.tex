...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\textwidth]{../../doc/logo/logo.png}
	\end{figure}
	\thispagestyle{empty}
	\newpage
	...
	\label{sec:etudes-des-cas-d-utilisation}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{../../doc/diagrams/use-case/use-case}
	...
	\label{sec:architecture-du-projet}
		...
		\subsection{GOLD Parser System \cite{goldparser}}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.8\textwidth]{../../doc/diagrams/pipeline/pipeline-gold-parser}
		...
		\subsection{Décomposition en sous-projets}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.6\textwidth]{../../doc/diagrams/misc/architecture-pp}
		...
		\subsection{Organisation de Platinum Parsing}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.8\textwidth]{../../doc/diagrams/pipeline/pipeline-output} 
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.8\textwidth]{../../doc/diagrams/pipeline/pipeline} 
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.8\textwidth]{../../doc/diagrams/pipeline/pipeline-full} 
		...
		\subsection{Séparation des fonctionnalités framework/CLI}
			...
			\subsubsection{Cas 1: interprétation du langage Lua}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=0.8\textwidth]{../../doc/diagrams/pipeline/pipeline-framework} 
			...
			\subsubsection{Cas 3: transformation d'une grammaire EBNF en tables}
				...
				\begin{figure}[H]
					\centering
					\includegraphics[width=0.8\textwidth]{../../doc/diagrams/pipeline/pipeline-framework-gold} 
	...
	\label{sec:generation-de-la-table-lalr}	
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.6\textwidth]{../../doc/diagrams/misc/generation-process}
	...
	\label{sec:generation-des-tables-dans-un-langage-cible}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.5\textwidth]{../../doc/diagrams/misc/template}
	...
	\label{sec:demonstration-en-csharp}
		...
		\subsection{Validation du \textit{pipeline}}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.7\textwidth]{../../doc/diagrams/misc/exemple-pipeline}
	...
	\section{Intégration de l'analyse lexicale}
		...
		\subsection{Génération des automates pour l'analyse lexicale}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.5\textwidth]{../../doc/diagrams/misc/dfa-exemple}
		...
		\subsection{Implémentation du \textit{lexer} complet}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.5\textwidth]{../../doc/diagrams/misc/lexer-dfa}
	...
	\section{Intégration à un éditeur de texte}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.7\textwidth]{../../doc/diagrams/atom/create-menu}
			\includegraphics[width=0.8\textwidth]{../../doc/diagrams/atom/create-dialog}
			\includegraphics[width=0.7\textwidth]{../../doc/diagrams/atom/create-folder}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.7\textwidth]{../../doc/diagrams/atom/created-project}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=\textwidth]{../../doc/diagrams/atom/simple-project}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.7\textwidth]{../../doc/diagrams/atom/build-menu}
			\includegraphics[width=0.8\textwidth]{../../doc/diagrams/atom/build-results}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.7\textwidth]{../../doc/diagrams/atom/test-menu}
			\includegraphics[width=0.8\textwidth]{../../doc/diagrams/atom/test-dialog}
			\includegraphics[width=0.5\textwidth]{../../doc/diagrams/atom/ast-viewer}
